# -----------------------------------------------------------------|
#   TO RUN TYPE:                                                   |
#   python all_in_one_cam.py --image park4.png --url no            |
# -----------------------------------------------------------------|
...
if (args.url == "yes"):
    ...
    #image_yolo3_tiny = copy(image)
    #image_ssd_mobilenet = copy(image)
    #image_yolo3_tiny = image
    #image_ssd_mobilenet = image
    #image_alexnet = image

else:
    #(image_yolo3, image_yolo3_tiny, image_ssd_mobilenet) = (cv2.imread(args.image),cv2.imread(args.image),cv2.imread(args.image))
